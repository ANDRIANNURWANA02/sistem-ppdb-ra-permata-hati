...
<body class="bg-gray-100 text-gray-900 min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-4xl bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
        ...
        <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                <h3 class="text-xl font-semibold text-gray-700 mb-4 border-b-2 border-yellow-500 pb-2">Identitas Calon
                    Siswa</h3>
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-gray-600 mb-1">Nama Lengkap</label>
                        <input type="text" name="nama_lengkap" required
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="jumlah_saudara_kandung" required
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400">
                    </div>
                    <div>
                        <label class="block text-gray-600 mb-1">Jumlah saudara tiri</label>
                        <input type="text" name="jumlah_saudara_tiri" required
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400">
                    </div>
                    <div>
                        <label class="block text-gray-600 mb-1">Jumlah saudara angkat</label>
                        <input type="text" name="jumlah_saudara_angkat" required
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400">
                    </div>
                    <div>
                        <label class="block text-gray-600 mb-1">Bahasa sehari - hari</label>
                        <input type="text" name="bahasa_sehari_hari" required
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400">
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat_lengkap" rows="2"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400"></textarea>
                    </div>
                </div>
            </div>
            ...
            <!-- IDENTITAS AYAH -->
            <div>
                <h3 class="text-xl font-semibold text-gray-700 mb-4 border-b-2 border-yellow-500 pb-2">Identitas Ayah
                </h3>
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="pangkat_ayah"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400">
                    </div>
                    <div>
                        <label class="block text-gray-600 mb-1">Golongan Darah</label>
                        <input type="text" name="golongan_darah_ayah"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400">
                    </div>
                    <div>
            ...
            <div>
                ...
                <!-- IDENTITAS IBU -->
                <h3 class="text-xl font-semibold text-gray-700 mb-4 border-b-2 border-yellow-500 pb-2">Identitas Ibu
                </h3>
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        <label class="block text-gray-600 mb-1">Pangkat</label>
                        <input type="text" name="pangkat_ibu"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400">
                    </div>
                    <div>
                        <label class="block text-gray-600 mb-1">Golongan Darah</label>
                        <input type="text" name="golongan_darah_ibu"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400">
                    </div>
                    <div>
                        <label class="block text-gray-600 mb-1">Besar Penghasilan (Rp)</label>
                    ...
                    {{-- <div>
                        ...
                        <input type="text" name="kemampuan"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring-yellow-400 focus:border-yellow-400">
                    </div> --}}
                </div>
            </div>
