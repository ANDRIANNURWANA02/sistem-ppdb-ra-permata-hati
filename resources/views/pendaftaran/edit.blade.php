...
@section('content')
    ...
    ? route('pendaftaran.update', $pendaftaran->id) 
    : route('user.pendaftaran.update') }}" 
    ...
    @endif
                ...
                <div class="mb-4 mt-4">
                    ...
                    <input type="text" id="kewarganegaraan" name="kewarganegaraan"
                        value="{{ old('kewarganegaraan', $pendaftaran->kewarganegaraan) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>
                ...
                <div class="mb-4 mt-4">
                    <label for="jumlah_saudara_kandung" class="block text-gray-700 font-semibold mb-2">Jumlah Saudara
                        Kandung</label>
                    <input type="text" id="jumlah_saudara_kandung" name="jumlah_saudara_kandung"
                        value="{{ old('jumlah_saudara_kandung', $pendaftaran->jumlah_saudara_kandung) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>

                {{-- jumlah saudara tiri --}}
                <div class="mb-4 mt-4">
                    <label for="jumlah_saudara_tiri" class="block text-gray-700 font-semibold mb-2">Jumlah Saudara
                        Tiri</label>
                    <input type="text" id="jumlah_saudara_tiri" name="jumlah_saudara_tiri"
                        value="{{ old('jumlah_saudara_tiri', $pendaftaran->jumlah_saudara_tiri) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>

                {{-- jumlah saudara angkat --}}
                <div class="mb-4 mt-4">
                    <label for="jumlah_saudara_angkat" class="block text-gray-700 font-semibold mb-2">Jumlah Saudara
                        Angkat</label>
                    <input type="text" id="jumlah_saudara_angkat" name="jumlah_saudara_angkat"
                        value="{{ old('jumlah_saudara_angkat', $pendaftaran->jumlah_saudara_angkat) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>

                {{-- Bahasa sehari hari --}}
                <div class="mb-4 mt-4">
                    <label for="bahasa_sehari_hari" class="block text-gray-700 font-semibold mb-2">Bahasa
                        Sehari-hari</label>
                    <input type="text" id="bahasa_sehari_hari" name="bahasa_sehari_hari"
                        value="{{ old('bahasa_sehari_hari', $pendaftaran->bahasa_sehari_hari) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>
                ...
                <div class="mb-4 mt-4">
                    ...
                    <input type="text" id="golongan_darah" name="golongan_darah"
                        value="{{ old('golongan_darah', $pendaftaran->golongan_darah) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>
                ...
                <div class="mb-4 mt-4">
                    ...
                    <input type="text" id="imunisasi" name="imunisasi"
                        value="{{ old('imunisasi', $pendaftaran->imunisasi) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>
                ...
                <div class="mb-4 mt-4">
                    ...
                    <input type="text" id="ciri_khusus" name="ciri_khusus"
                        value="{{ old('ciri_khusus', $pendaftaran->ciri_khusus) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>
                ...
                <div class="mb-4 mt-4">
                    ...
                    <input type="text" id="makanan_kesukaan" name="makanan_kesukaan"
                        value="{{ old('makanan_kesukaan', $pendaftaran->makanan_kesukaan) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>
                ...
                <div class="mb-4 mt-4">
                    ...
                    <input type="text" id="minuman_kesukaan" name="minuman_kesukaan"
                        value="{{ old('minuman_kesukaan', $pendaftaran->minuman_kesukaan) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>
                ...
                <div class="mb-4 mt-4">
                    ...
                    <input type="text" id="buah_kesukaan" name="buah_kesukaan"
                        value="{{ old('buah_kesukaan', $pendaftaran->buah_kesukaan) }}"
                        class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="tempat_lahir_ibu" name="tempat_lahir_ibu"
                            value="{{ old('tempat_lahir_ibu', $pendaftaran->tempat_lahir_ibu) }}"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="agama_ibu" name="agama_ibu"
                            value="{{ old('agama_ibu', $pendaftaran->agama_ibu) }}"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label for="kewarganegaraan_ayah"
                            class="block text-gray-700 font-semibold mb-2">Kewarganegaraan</label>
                    ...
                    <div>
                        <label for="kewarganegaraan_iu"
                            class="block text-gray-700 font-semibold mb-2">Kewarganegaraan</label>
                        <input type="text" id="kewarganegaraan_iu" name="kewarganegaraan_iu"
                            value="{{ old('kewarganegaraan_iu', $pendaftaran->agama_ibu) }}"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        <label for="kewarganegaraan_ibu"
                            class="block text-gray-700 font-semibold mb-2">Kewarganegaraan</label>
                        <input type="text" id="kewarganegaraan_ibu" name="kewarganegaraan_ibu"
                            value="{{ old('kewarganegaraan_ibu', $pendaftaran->kewarganegaraan_ibu) }}"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label for="pendidikan_terakhir_ayah" class="block text-gray-700 font-semibold mb-2">Pendidikan
                            Terakhir</label>
                    ...
                    <div>
                        <label for="pendidikan_terakhir_ibu" class="block text-gray-700 font-semibold mb-2">Pendidikan
                            Terakhir</label>
                        <input type="text" id="pendidikan_terakhir_ibu" name="pendidikan_terakhir_ibu"
                            value="{{ old('pendidikan_terakhir_ibu', $pendaftaran->pendidikan_terakhir_ibu) }}"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label for="golongan_darah_ayah" class="block text-gray-700 font-semibold mb-2">Golongan
                            Darah</label>
                    ...
                    <div>
                        <label for="golongan_darah_ibu" class="block text-gray-700 font-semibold mb-2">Golongan
                            Darah</label>
                        <input type="text" id="golongan_darah_ibu" name="golongan_darah_ibu"
                            value="{{ old('golongan_darah_ibu', $pendaftaran->golongan_darah_ibu) }}"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="pangkat_ibu" name="pangkat_ibu"
                            value="{{ old('pangkat_ibu', $pendaftaran->pangkat_ibu) }}"
                            class="w-full border-gray-300 rounded-lg p-2 focus:ring focus:ring-yellow-400" required>
                    </div>
                </div>
        ...
        : route('user.beranda') }}" class="bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded-lg">
                        ⬅ Kembali
                    </a>

                    <button type="submit"
                        class="bg-yellow-500 hover:bg-yellow-600 text-white px-6 py-2 rounded-lg font-semibold">
                        Simpan Perubahan
                    </button>
                </div>
