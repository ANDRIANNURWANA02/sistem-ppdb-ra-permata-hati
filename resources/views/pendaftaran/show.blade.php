...
@section('content')
    ...
    <div class="flex gap-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow rounded-lg p-5 col-span-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div><span class="text-gray-500">Jumlah Saudara
                            Kandung</span><br>{{ $pendaftaran->jumlah_saudara_kandung }}</div>
                    <div><span class="text-gray-500">Jumlah Saudara Tiri</span><br>{{ $pendaftaran->jumlah_saudara_tiri }}
                    </div>
                    <div><span class="text-gray-500">Jumlah Saudara
                            Angkat</span><br>{{ $pendaftaran->jumlah_saudara_angkat }}</div>
                    <div><span class="text-gray-500">Bahasa Sehari Hari</span><br>{{ $pendaftaran->bahasa_sehari_hari }}
                    </div>
            ...
            <div class="bg-white shadow rounded-lg p-5 col-span-2">
                ...
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div><span class="text-gray-500">Tanggal
                                Lahir</span><br><b>{{ $pendaftaran->tanggal_lahir_ayah }}</b></div>
                        ...
                        <div><span class="text-gray-500">Golongan Darah</span><br>{{ $pendaftaran->golongan_darah_ayah }}
                        </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div><span class="text-gray-500">Tanggal
                                Lahir</span><br><b>{{ $pendaftaran->tanggal_lahir_ibu }}</b></div>
        ...
        <div class="flex justify-between mt-8">
            <a href="{{ route('admin.dashboard') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-5 py-2 rounded-lg">
                ⬅ Kembali
            </a>
